...
export class VideographerController {
   ...
   * GET /api/v1/videographers/search/availability/:availability
   */
  public searchByAvailability = async (
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
    try {
      ...
      const videographers = await this.videographerService.searchByAvailability(availability);
   ...
   * GET /api/v1/videographers/search/skill/:skill
   */
  public searchBySkill = async (
    ...
    try {
      ...
      const videographers = await this.videographerService.searchBySkill(skill);
  ...
  /**
   * Search videographers by hourly rate range
   * GET /api/v1/videographers/search/rate?min=50&max=200
   */
  public searchByRate = async (
    ...
    try {
      ...
      const videographers = await this.videographerService.searchByHourlyRate(minRate, maxRate);
   ...
   * GET /api/v1/videographers/search/experience/:level
   */
  public searchByExperience = async (
    ...
    try {
      ...
      const videographers = await this.videographerService.searchByExperienceLevel(level);

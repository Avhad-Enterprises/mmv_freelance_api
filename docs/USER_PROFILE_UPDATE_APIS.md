...
```json
{
  ...
  "data": {
    ...
    "profile": {
      ...
      "budget_min": 5000,
      "budget_max": 25000,
      "business_document_urls": ["https://example.com/business-doc1.pdf", "https://example.com/business-doc2.pdf"],
      ...
      "bank_account_info": {
        "account_holder_name": "ABC Productions LLC",
        "account_number": "****1234",

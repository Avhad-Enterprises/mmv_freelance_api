...
/**
 * Get User Roles API Test
 *
 * Tests the /users/:id/roles endpoint (GET method) for admin user roles retrieval
 */
...
console.log('👥 Get User Roles API Test');
console.log('===========================');
console.log(`Base URL: ${BASE_URL}`);
console.log(`Endpoint: ${API_PREFIX}${ENDPOINT}/:id/roles (GET)`);
console.log('');
...
const TEST_CASES = [
  ...
  // ============== VALID REQUESTS ==============
  {
    name: "Valid User Roles Retrieval - Super Admin",
    description: "Test retrieving user roles with super admin token",
    urlPath: `${ENDPOINT}/${testUserId}/roles`,
    headers: {}, // Will be set dynamically with super admin token
    expectedStatus: 200,
  ...
  {
    name: "Valid User Roles Retrieval - Admin",
    description: "Test retrieving user roles with admin token",
    urlPath: `${ENDPOINT}/${testUserId}/roles`,
...
async function runTests() {
  ...
  try {
    const testUserEmail = `test-user-roles-${Date.now()}@example.com`;
